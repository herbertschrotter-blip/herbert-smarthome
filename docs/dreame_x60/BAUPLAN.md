...
| 4.0 | Navigation `dx-nav` (Seitenleiste / Symbolleiste / Tab-Leiste) + Bento-Übersicht mit Platzhaltern | fertig (15.09.; nav.js 28, render.js 42 grün; Version 2.0.0-alpha.2 eingespielt); Sichtprüfung durch Herbert offen, PD-007 offen |
| 4.1 | `dx-hero` | offen |
