...
| F.1 | **Diagnose-Protokoll** (Modul F, DX-068: HA-Zustände mit Auslöser, Debuglog der Integration, Kartenanzeige) | offen (Karte in Abschnitt 8 seit 18.09.; Herbert: als Nächstes) |
...
| **F Backend** (parallel) | **F.1 Diagnose-Protokoll (DX-068) – als Nächstes (Herbert, 18.09.)**, Planer nachholen (DX-048), 0.4-Entscheidung (DX-006), 2.7 **[PC]** (DX-019) | Paket, Automationen, Prognose | offen |
