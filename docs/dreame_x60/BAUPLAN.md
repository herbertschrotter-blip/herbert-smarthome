...
| 4.1 | `dx-hero` + `dx-auftrag` | fertig (15.09.; hero.js 16 grün inkl. 85 v1-Kopf-Zustände und Render-Ruhe, strip.test.ts grün; Version 2.0.0-alpha.9 eingespielt; Startpunkt-Fall, Knopfbreite, Stationszeile, Lade-Blitz, „Mopp“ und PD-009 am echten Lauf nachgebessert; **Nachtrag PD-015 gebaut 17.09.:** Hinweis-Chip mit Kurz-/Langtext, Tooltip `dx-tip`, ✕ bei Warnung → `button.press` auf `clear_warning`, hero.js 32 grün, Version 2.0.0-alpha.30 eingespielt); Sichtprüfung durch Herbert offen |
