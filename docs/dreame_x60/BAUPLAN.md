...
| F.2 | **Seite „Dev“, Tickets, Knopf „Fehler melden“** (Modul F, DX-069: Live-Zeitleiste, Auswertung mit 23 Regeln, Ticketsystem HT-NNNN mit Status, Skill `ticket`; Teilschritte F.2a Backend, F.2b Karte, F.2c Skill) | Mockup `dev.html` abgenommen 18.09. (PD-018 freigegeben); F.2a Backend in Arbeit, F.2b Karte und F.2c Skill offen |
