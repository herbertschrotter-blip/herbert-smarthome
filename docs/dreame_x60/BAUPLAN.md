...
| F.2 | **Seite „Dev“, Tickets, Knopf „Fehler melden“** (Modul F, DX-069: Live-Zeitleiste, Auswertung mit 23 Regeln, Ticketsystem HT-NNNN mit Status, Skill `ticket`; Teilschritte F.2a Backend, F.2b Karte, F.2c Skill) | Mockup `dev.html` erstellt 18.09., Abnahme Herbert offen (PD-018 offen) |
