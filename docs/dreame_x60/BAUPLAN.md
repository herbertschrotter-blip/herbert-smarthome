...
| F.2 | **Seite „Dev“ + Knopf „Fehler melden“** (Modul F, DX-069: Live-Zeitleiste des Diagnose-Protokolls in der Karte, Meldung setzt Marke) | Mockup `dev.html` erstellt 18.09., Abnahme Herbert offen (PD-018 offen) |
