...
| 4.3e | **Einrichtungsprüfung** `dx-setup` (Knopf in der Kopfzeile nur bei Befund → Dialog „Einrichtung“: Roboter, Paket, Roboter-Entitäten, Datenkarte, Angepasste Reinigung, Raumtypen, Räume ↔ HA-Bereiche, Reparaturen; Sprung zur Stelle; PD-014) | fertig (16.09.; setup.test.ts 7 grün, setup.js 20 grün; Version 2.0.0-alpha.21 eingespielt) |
