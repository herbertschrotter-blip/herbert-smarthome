...
| 4.1 | `dx-hero` + `dx-auftrag` | fertig (15.09.; hero.js 16 grün inkl. 85 v1-Kopf-Zustände und Render-Ruhe, strip.test.ts grün; Version 2.0.0-alpha.7 eingespielt; Startpunkt-Fall, Knopfbreite, Stationszeile und Lade-Blitz am echten Lauf nachgebessert); Sichtprüfung durch Herbert offen |
