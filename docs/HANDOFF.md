...
## 3e. Projekt dreame_x60 – Neubau der Karte (seit 14.09.2026; letzter Stand 19.09.2026, Sitzung Teil 6: Version 2.0.0-alpha.39, alle Tickets bearbeitet)
...
- [ ] **Sichtprüfung Herbert nach Strg+F5 (Version 2.0.0-alpha.39; neu sichtbar: Seite Dev, Knopf „Fehler melden“; **DX-071:** Live-Karte der Übersicht läuft als HA-Live-Ansicht – von Herbert am 18.09. im Lauf geprüft („läuft flüssig“)):** Roboter-Panel (DX-026), Texte unverändert nach 4.14 (DX-066); Warnungs-Chip mit ✕ und Fortschrittsbalken erst beim nächsten echten Fall bzw. Lauf sichtbar – dabei prüfen, wie der Roboter den Fortschritt bei Raumaufträgen rechnet (PD-016).
