...
- [ ] **Entitäten-Durchgang (Modul R, ohne eigene ClickUp-Aufgabe, läuft unter DX-026/DX-064):** erledigt bis 4. (`mapping_time` nicht integrieren, `relocation_status` gebaut als PD-020, alpha.40); stehen geblieben bei 5. `sensor.heidi_state`, danach `sensor.heidi_stream_status`, `sensor.heidi_task_type`, `switch.heidi_resume_cleaning`, dann „Akku und Laden“; Stand in ENTITAETEN.md (Kopf) und Bauplan Abschnitt 10 (19.09.).
