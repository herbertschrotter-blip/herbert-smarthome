...
- [ ] **Sichtprüfung Herbert nach Strg+F5 (Version 2.0.0-alpha.38; neu sichtbar: Seite Dev, Knopf „Fehler melden“; **DX-071:** Live-Karte der Übersicht läuft als HA-Live-Ansicht – von Herbert am 18.09. im Lauf geprüft („läuft flüssig“)):** Roboter-Panel (DX-026), Texte unverändert nach 4.14 (DX-066); Warnungs-Chip mit ✕ und Fortschrittsbalken erst beim nächsten echten Fall bzw. Lauf sichtbar – dabei prüfen, wie der Roboter den Fortschritt bei Raumaufträgen rechnet (PD-016).
