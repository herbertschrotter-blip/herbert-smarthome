...
- [ ] **DX-068 (F.1) Diagnose-Protokoll – Schicht 1 + 2 laufen seit 18.09. 20:27** (ClickUp in development, Titel/Template/Felder nachgezogen). Offen: (a) **Probe Herbert:** je ein Start aus Dreame-App, Dashboard und Planer, danach `node tools\diag.js` – erwartet „extern“, „Benutzer Herbert Schrotter“, „Automation Heidi: Planer“; (b) nach ein paar Tagen Größe von `H:\prognose\diag\` ansehen; (c) Schicht 3 (Karte feuert `dreame_x60_anzeige`): PD-Eintrag, Abschnitt 4, neue alpha-Version.
