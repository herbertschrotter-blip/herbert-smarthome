...
- **Nächstes:** Modul R – 4.1 Sichtprüfung `dx-hero`/`dx-auftrag` durch Herbert (DX-026; Herbert geht die Roboter-Entitäten einzeln durch – 1. `clear_warning`: Hinweis-Chip mit ✕, Kurz-/Langtext, PD-015, Mockup `warnung.html` abgenommen 17.09.; Liste aller 142 Codes in ENTITAETEN.md), 4.14 Texte zentral `src/i18n/de.ts` + `t()` (DX-066, i18n Stufe 1; Sprachumschaltung Post-2.0 DX-067), 4.6a Räume-Dialog Roboter-Modus (DX-033, legt `tests/e2e/widths.js` an); dann Modul A Planer – 4.4 `dx-planer` (DX-031), 4.5 Editor + Uhr (DX-032), 4.6b (DX-065), 4.8, 6.1; später Heidi-Karte: Zoom, Zone/Punkt/Hinfahren als Gesten, Sperrzonen (4.12) auf derselben Ebene. Offene Entscheidungen: Bauplan Abschnitt 10 und ClickUp.
