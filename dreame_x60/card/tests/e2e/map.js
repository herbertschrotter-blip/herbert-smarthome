...
// ── Seite Reinigen mit Xiaomi-Karte ──
{
  ...
  H.checkEqual('OK → dreame_vacuum.vacuum_clean_segment mit segments [7, 6]', await page.evaluate(() => window._calls), [['dreame_vacuum', 'vacuum_clean_segment', { entity_id: 'vacuum.heidi', segments: [7, 6] }]]);
...
// ── Übersicht: compact (Kamerabild), Bildunterschrift, Antippen → reinigen, Reiter, dx-quickstart ──
{
  ...
  H.checkEqual('Schnellstart OK → vacuum_clean_segment mit allen sieben Räumen (7..1)', await page.evaluate(() => window._calls), [['dreame_vacuum', 'vacuum_clean_segment', { entity_id: 'vacuum.heidi', segments: [7, 6, 5, 4, 3, 2, 1] }]]);
