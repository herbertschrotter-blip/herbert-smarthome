...
const browserGlobals = { window: 'readonly', document: 'readonly', customElements: 'readonly', HTMLElement: 'readonly', CustomEvent: 'readonly', Event: 'readonly', history: 'readonly', location: 'readonly', getComputedStyle: 'readonly', MouseEvent: 'readonly', console: 'readonly', setTimeout: 'readonly', clearTimeout: 'readonly', requestAnimationFrame: 'readonly' };
